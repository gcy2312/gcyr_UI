...
export const ToastExample = (args: ToastProps) => {
  ...
  return (
    <Toast
      ...
      title={'Product added'}
      text={
        "You've successfully added a product to your Available Products List."
      }
...
export const ToastActionsExample = (args: ToastProps) => {
  ...
  return (
    <Toast
      ...
      text={
        'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed eu urna quis sapien convallis consequat.'
      }
      Icon={<FolderIcon className="text-gray-400" />}
      actions={
...
export const ToastAvatarExample = (args: ToastProps) => {
  ...
  return (
    <Toast
      ...
      setOpen={setOpen}
      title={'Brad Pitt'}
      text={"You've received an invitation to connect."}
      avatar={true}
      Icon={<img src={profilePic} />}
      actions={
        <div className="space-x-3">
          <Button
            id={''}
